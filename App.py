...
if st.button("Generate Prompt", type="primary"):
    if estilo_seleccionado == "Initial of a word" and not inicial_palabra:
        ...
        base_prompt = "A creative, unique, highly detailed keychain design."
        
        # Add the style and other details
        ...
        # Generate the specific prompts for each variation
        ...
        # Combine the prompts into a grid format
        prompt_completo = (
        ...
        st.text_area("Copy your prompt here:", prompt_completo, height=450)
